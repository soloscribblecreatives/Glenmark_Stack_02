...
function checkClickThrough(){
	...
	if(currentslide == 1){
		document.getElementById("click_through").innerHTML='<div class="s1_pop1" onclick="checkBtns(1)"></div><div class="s1_pop2" onclick="checkBtns(2)"></div><div class="s1_pop3" onclick="checkBtns(3)"></div><div class="s1_pop4" onclick="checkBtns(4)"></div><div class="s1_pop5" onclick="checkBtns(5)"></div><div class="s1_pop6" onclick="checkBtns(6)"></div>';
	}
    if(currentslide == 4){
		document.getElementById("click_through").innerHTML='<div class="s4_pop1" onclick="checkBtns(5)"></div>';
	}
	if(currentslide == 5){
		document.getElementById("click_through").innerHTML='<div class="s5_pop1" onclick="checkBtns(5)"></div>';
	}
	if(currentslide == 6){
		document.getElementById("click_through").innerHTML='<div class="s6_pop1" onclick="checkBtns(5)"></div>';
	}
	if(currentslide == 7){
		document.getElementById("click_through").innerHTML='<div class="s7_pop1" onclick="checkBtns(5)"></div>';
	}
}

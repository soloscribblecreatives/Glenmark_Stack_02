...
switch(pg_id){
	...
	break;
    case 2:
	content='<link rel="stylesheet" type="text/css" href="slide2/slide2.css" media="screen"/><div class="background"><img src="slide2/1.jpg" width="1024" height="768" alt=""></div><div class="s3_1"><img src="slide2/2.jpg" width="1024" height="768" alt=""/></div><div class="s3_pop1" onclick="s3_pop1()"></div><div class="s3_2"><img src="slide2/3.jpg" width="1024" height="768" alt=""/></div><div class="s3_pop2" onclick="s3_pop2()"></div><div class="s3_3"><img src="slide2/4.jpg" width="1024" height="768" alt=""/></div><div class="s3_pop3" onclick="s3_pop3()"></div><div class="s3_4"><img src="slide2/5.jpg" width="1024" height="768" alt=""/></div><div class="s3_pop4" onclick="s3_pop4()"></div><div class="s3_c1ose1" onclick="s3_close1()"></div>';
	break;
}
